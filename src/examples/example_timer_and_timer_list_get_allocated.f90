...
contains
   ...
   function timer_list_get(self, label, found) result(timer)
...
program example
   ...
   timer_from_list = timer_list%get('Column-first', found)
   if (found) then
      call timer_from_list%end()
   end if
